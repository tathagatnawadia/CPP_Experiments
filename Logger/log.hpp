...
namespace logging { 
  /*
   * Interface : log_policy_interface
   */
  ...
  /*
   * file_log_policy implemeting the interface with FILE logging (only helps in logging onto a file, not a terminal, can be implemented for a terminal)
   */
